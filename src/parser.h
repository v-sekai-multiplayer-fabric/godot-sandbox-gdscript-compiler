...
private:
  ...
  // Type hint parsing
  std::string
  parse_type_hint(); // Parse optional type hint (e.g., ": int", ": String")
  std::string
  parse_return_type(); // Parse optional return type (e.g., "-> void")

  // Attribute parsing
  bool
  parse_attribute(); // Parse attribute (e.g., @export), returns true if @export
